...
| Mod | Workshop | Why |
|---|---|---|
| **Shared World Map** | [`2815010161`](https://steamcommunity.com/sharedfiles/filedetails/?id=2815010161) | Syncs exploration (live / region / full share + request). On active [roadmap](roadmap.md) — absorb vs keep external TBD. Until decided, still the recommended external fix for map fog. |
...
- [Feature roadmap](roadmap.md) — what we build ourselves  
- [Catalog acknowledgements](catalog-ack.md) — researched, not committed  
