...
| `BossFightDamageMultiplier` | `1.0` | **Done** | Damage taken during boss fights (0.5–3.0, step 0.1) — see [boss fight damage](boss-fight-damage.md) |
| `BossFightDamageDealtMultiplier` | `1.0` | **Done** | Damage dealt during boss fights (0.5–3.0, step 0.1) — see [boss fight damage](boss-fight-damage.md) |
| `BossFightBossHealthMultiplier` | `1.0` | **Done** | Boss segment HP at spawn (0.5–3.0, step 0.1) — see [boss fight damage](boss-fight-damage.md) |
...
| Slider | `SliderColor(224, 165, 56, 128)` on `SharedHealthMultiplier`, `BossFightDamageMultiplier`, `BossFightDamageDealtMultiplier`, `BossFightBossHealthMultiplier` |
...
- [Boss fight damage](boss-fight-damage.md)
