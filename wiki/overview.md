...
- **Implemented:** [TeamToJoin](concepts/team-to-join.md) (join-once); [Free team wormhole](concepts/free-team-wormhole.md) (virtual potion).
- **Scaffold / not built:** boss no-respawn, spectate.
...
| Area | Pages |
|---|---|
| Concepts | [Mod anatomy](concepts/mod-anatomy.md) · [TeamToJoin](concepts/team-to-join.md) · [Free team wormhole](concepts/free-team-wormhole.md) · [Scaffold conventions](concepts/scaffold-conventions.md) · [Multiplayer config rules](concepts/multiplayer-config-rules.md) |
