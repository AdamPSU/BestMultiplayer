...
- **Implemented:** [TeamToJoin](concepts/team-to-join.md); [Free team wormhole](concepts/free-team-wormhole.md); [Boss fight lives](concepts/boss-fight-lives.md).
...
| Area | Pages |
|---|---|
| Concepts | [Mod anatomy](concepts/mod-anatomy.md) · [TeamToJoin](concepts/team-to-join.md) · [Free team wormhole](concepts/free-team-wormhole.md) · [Boss fight lives](concepts/boss-fight-lives.md) · [Scaffold conventions](concepts/scaffold-conventions.md) · [Multiplayer config rules](concepts/multiplayer-config-rules.md) |
...
- 2026-07-27 — FreeTeamWormhole via `HasUnityPotion`/`TakeUnityPotion` hooks; optional boss block.
